...
### PROJ_001 – Avaliação Automática de Redações com NLP e BERT
Sistema de avaliação automática de textos no estilo ENEM, com construção de corpus anotado, pré-processamento em Python e fine-tuning de modelos BERT (BERTimbau, RoBERTa, Albertina).

**Técnicas e Ferramentas:**
- Web Scraping, Regex, Pandas
- Fine-tuning com Transformers (Hugging Face)
- Validação cruzada e métricas (F1, Kappa)
- JSON estruturado e preparação de corpus

🔗 [Acesse o projeto](https://github.com/laicsiifes/aes_enem_corpus)

---

### PROJ_002 – Chat com PDFs usando LLMs, RAG e IA Generativa  
...
🔗 [Acesse o projeto](https://github.com/grazimartins/chat-pdf-rag)
...
- Engenharia de atributos, GridSearchCV e SMOTE
- API REST com FastAPI
- Chatbot interativo com Streamlit

🔗 [Acesse o projeto](https://github.com/grazimartins/case-juscash)
...
- Modelos: LinearRegression, RandomForest, XGBoost, Prophet  
- Validação temporal (TimeSeriesSplit, backtesting)  
